                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4"  method="post" action="sendMessage?to_mnum=${m.mnum}&gseq=${gseq}&to_mname=${m.mname}&from_mname=${message.from_mname}">
                        ...
                        <div class="d-flex flex-row align-items-center mb-0">
                          ...
                          <div class="form-outline flex-fill mb-2">
                            ...
                            <input
                              ...
                              id="form3Example1c"
                              class="form-control"
                              value="${message.from_mname}" disabled
                            />
                          </div>
                        </div>
