          ...
          <div class="button_group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a
                  class="dropdown-item"
                  href="MmGbListPage?pageSize=1&mnum=${mnum}"
                  >1</a
                >
              </li>
              <li>
                <a
                  class="dropdown-item"
                  href="MmGbListPage?pageSize=5&mnum=${mnum}"
                  >5</a
                >
              </li>
              <li>
                <a
                  class="dropdown-item"
                  href="MmGbListPage?pageSize=10&mnum=${mnum}"
                  >10</a
                >
              </li>
              <li>
                <a
                  class="dropdown-item"
                  href="MmGbListPage?pageSize=15&mnum=${mnum}"
                  >15</a
                >
              </li>
            </ul>
              ...
              >
                <c:if test="${pm.prev}">
                  <li class="page-item">
                    <a
                      class="page-link"
                      href="MmGbListPage?page=${pm.startPage-1}&pageSize=${cri.pageSize}&mnum=${mnum}"
                      >처음</a
                    >
                  </li>
                </c:if>
                <c:if test="${pm.prev}">
                  <li class="page-item">
                    <a
                      class="page-link"
                      href="MmGbListPage?page=${cri.page-1}&pageSize=${cri.pageSize}&mnum=${mnum}"
                      >이전</a
                    >
                  </li>
                </c:if>
                ...
                >
                  <li class="page-item">
                    <a
                      class="page-link"
                      href="MmGbListPage?page=${idx }&pageSize=${cri.pageSize}&mnum=${mnum}"
                      >${idx}</a
                    >
                  </li>
                </c:forEach>
                ...
                <c:if test="${pm.next && pm.endPage > 0}">
                  <li class="page-item">
                    <a
                      class="page-link"
                      href="MmGbListPage?page=${pm.endPage}&pageSize=${cri.pageSize}&mnum=${mnum}"
                      >끝</a
                    >
                  </li>
                </c:if>
