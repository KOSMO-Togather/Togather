...
public class MyPageController {
	...
	public ModelAndView makesecondCategoryblank(long second, HttpSession session,Member member) {
	...
	public ModelAndView makethirdCategoryblank(long third, Member member, HttpSession session) {
