...
public class MemberController {
  ...
  public int join(
    Member member,
    HttpSession session,
    String category_first,
    String category_second,
    String category_third
  ) {
  ...
  public ModelAndView messageContent(
    long meseq,
    IndexCriteria cri,
    HttpServletRequest request
  ) {
